...
export class Runner {
  constructor(ctx) {
    this.ctx = ctx;
    this.spritesheetUrl = "spritesheets/runner-nita.png";
  ...
  load(loadingFinished) {
    ...
    this.spritesheet.addEventListener("load", () => {
      ...
      this.initialY =
        this.gameHeight - this.spriteHeight - parseInt(this.gameHeight * 0.12);
    ...
    switch (this.runnerState) {
      case this.RUNNER_STATE.STANDING:
        ...
        this.currentSpriteIndex =
          this.currentSpriteIndex + this.velocity * speed;
        ...
        if (this.jumpState <= this.JUMP_DURATION / 3) {
          ...
          this.jumpY =
            ...
            Math.abs(
              this.jumpLimit *
                (1 -
                  (this.JUMP_DURATION / 3 - this.jumpState) /
                    (this.JUMP_DURATION / 3))
            );
          ...
          this.jumpState > this.JUMP_DURATION / 3 &&
